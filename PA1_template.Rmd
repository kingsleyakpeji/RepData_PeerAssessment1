...
The mean and median total number of steps taken each day are `r mean_tot_steps_day` and `r med_tot_steps_day`, respectively.
...
`r mean_tot_steps_day2` and `r med_tot_steps_day2`, respectively.
